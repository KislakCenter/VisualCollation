    ...
    render() {
        ...
        return (
            <div>
                ...
                />
                <div role="main"
                     className={this.state.projectDrawerOpen ? 'dashboardWorkspace projectPanelOpen' : 'dashboardWorkspace'}>
                ...
                <Feedback tabIndex={this.modalIsOpen() ? -1 : 0}
                          togglePopUp={(v) => this.setState({ feedbackOpen: v })}/>
            </div>
        );
    }
}
