...
describe 'PUT /leafs/:id', type: :request do
  ...
  context 'and valid authorization' do
    context 'and standard leaf' do
      before do
        put "/leafs/#{@leafs[0].id}", params: @parameters.to_json,
    ...
    context 'and missing page' do
      before do
        put "/leafs/#{@leafs[0].id}waahoo", params: @parameters.to_json,
                                            headers: { 'Authorization' => @authToken, 'CONTENT_TYPE' => 'application/json', 'ACCEPT' => 'application/json' }
  ...
  context 'with empty authorization' do
    before do
      put "/leafs/#{@leafs[0].id}", params: @parameters.to_json, headers: { 'Authorization' => '' }
    end
  ...
  context 'invalid authorization' do
    before do
      put "/leafs/#{@leafs[0].id}", params: @parameters.to_json, headers: { 'Authorization' => '123456789' }
    end
