  ...
  context 'with valid authorization' do
    context 'and correct group target' do
      before do
        ...
        put "/terms/#{@term.id}/unlink", params: @parameters.to_json,
      ...
      it 'removes the term from the target' do
    ...
    context 'and a project belonging to another user' do
      ...
      context 'and group target' do
        before do
          ...
          put "/terms/#{@term.id}/unlink", params: @parameters2.to_json,
                                           headers: { 'Authorization' => @authToken, 'CONTENT_TYPE' => 'application/json', 'ACCEPT' => 'application/json' }
          @group2.reload
        end
    ...
    context 'and missing term' do
      before do
        put "/terms/#{@term.id}missing/unlink", params: @parameters.to_json,
                                                headers: { 'Authorization' => @authToken, 'CONTENT_TYPE' => 'application/json', 'ACCEPT' => 'application/json' }
        @body = JSON.parse(response.body)
      end
