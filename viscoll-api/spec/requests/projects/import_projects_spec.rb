...
describe 'PUT /projects/import', type: :request do
  ...
  describe 'JSON imports' do
    let(:import_data) do
      File.open("#{File.dirname(__FILE__)}/../../fixtures/sample_import_json.json", 'r', &:read)
    end
    ...
    it 'imports properly' do
      ...
      expect {
        put '/projects/import', params: @parameters.to_json,
  ...
  describe 'XML imports' do
    let(:import_data) do
      File.open("#{File.dirname(__FILE__)}/../../fixtures/sample_import_xml.xml", 'r', &:read)
    end
    ...
    it 'shows error for invalid XML' do
