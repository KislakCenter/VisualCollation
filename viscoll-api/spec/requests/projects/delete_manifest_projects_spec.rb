...
describe 'DELETE /projects/:id/manifests', type: :request do
  ...
  context 'with valid authorization' do
    context 'with valid parameters' do
      before do
        delete "/projects/#{@project.id.to_str}/manifests", params: @parameters.to_json,
      ...
      it 'removes the manifest' do
        expect(@project.manifests.any? do |_key, manifest|
                 manifest['url'] == 'https://iiif.library.utoronto.ca/presentation/v2/hollar:Hollar_a_3000/manifest'
               end).to be false
      end
    end
    ...
    context 'with missing project' do
      before do
        delete "/projects/#{@project.id.to_str}missing/manifests", params: @parameters.to_json,
                                                                   headers: { 'Authorization' => @authToken, 'CONTENT_TYPE' => 'application/json', 'ACCEPT' => 'application/json' }
      end
