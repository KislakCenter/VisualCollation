...
RSpec.describe ControllerHelper::ImportMappingHelper, type: :helper do
  ...
  describe 'handleMappingImport' do
    it 'runs properly with images in various attachment situations' do
      # Prep user with preloaded images
      preloads = [
        FactoryGirl.create(:image, user: @user, projectIDs: [@project.id.to_s], filename: '1V.png',
                                   fileID: '5a28221ec199860e7a2f5fd1'),
        FactoryGirl.create(:image, user: @user, projectIDs: [@project.id.to_s], filename: '2R.png',
                                   fileID: '5a28221ec199860e7a1shibainu', id: '5a28221ec199860e7a2f5fd1shibainu'),
        FactoryGirl.create(:image, user: @user, projectIDs: [@project.id.to_s], filename: '2V.png',
                                   fileID: '0e7a2f5fd1waahoo', id: '5a28221ec199860e7a2f5fd1waahoo')
      ]
      ...
      expect(@project.sides[0].image['url']).to match(%r{http://127\.0\.0\.1:12345/images/\w+_1R\.png})
      ...
      expect(@project.sides[2].image['url']).to match(%r{http://127\.0\.0\.1:12345/images/\w+_2R\(copy\)\.png})
