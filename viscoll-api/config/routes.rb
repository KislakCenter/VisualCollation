...
Rails.application.routes.draw do
  ...
  resource :session, controller: 'sessions', only: %i[create destroy], defaults: { format: :json }
  resource :registration, controller: 'registrations', only: [:create], defaults: { format: :json }
  resource :registration, controller: 'rails_jwt_auth/registrations', only: %i[create update destroy]
  resource :password, controller: 'rails_jwt_auth/passwords', only: %i[create update]
  ...
  # USER ENDPOINTS
  resources :users, defaults: { format: :json }, only: %i[show update destroy]
  ...
  resources :projects, defaults: { format: :json }, only: %i[index show update destroy create]
  ...
  # GROUP ENDPOINTS
  resources :groups, defaults: { format: :json }, only: %i[update destroy create]
  ...
  resources :leafs, defaults: { format: :json }, only: %i[update destroy create]
  ...
  resources :terms, defaults: { format: :json }, only: %i[show update destroy create]
