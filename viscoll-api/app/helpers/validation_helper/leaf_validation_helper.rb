...
module ValidationHelper
  module LeafValidationHelper
    ...
    def validateAdditionalLeafParams(_project_id, _parentGroupID, memberOrder, noOfLeafs, conjoin, oddMemberLeftOut)
      ...
      elsif (noOfLeafs < 1) || (noOfLeafs > 999)
